...
#tree details
tree.file     = 'C:/Users/u3579238/Work/AMT/Models/trees/Gehyra uniq lineages 141113 final.tre'
...
drop.tip(tree,tip=outgroup)

# check that the tree tips match the model names
