...
model.dir       <- "C:/Users/u3579238/Work/Refugia/Stability/AWT_RF/maxent.output8"
stability.dir   <- "C:/Users/u3579238/Work/Refugia/Stability/AWT_RF/stability.8"
stability.file  <- "static.sum.cost.asc"

x <- 145.8
y <- -17.3
layer <- "bioclim_12.asc.gz"
env_value_name <- "annual precipitation (mm)"
